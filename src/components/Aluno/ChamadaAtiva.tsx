    ...
    <section className='relative overflow-hidden rounded-2xl bg-card p-6 shadow-xl border border-brand/10 group'>
      ...
      <div className='relative z-10 flex flex-col md:flex-row items-center gap-6'>
        <div className='flex-1 space-y-4 text-center md:text-left'>
          ...
          <div className='bg-brand/5 p-3 rounded-lg inline-block mx-auto md:mx-0'>
            <p className='text-sm text-text-muted'>
              Raio de validação: <span className='font-bold text-brand'>{chamadaAtiva.raio} metros</span>
            </p>
          </div>

          <h2 className='text-2xl font-bold text-text-main'>
            {turma.disciplina_nome || 'Disciplina Desconhecida'}
          </h2>
          ...
          <div className='flex items-center gap-4 justify-center md:justify-start'>
            <div className='flex flex-col'>
              ...
              <span className='text-sm font-semibold text-text-main'>{nomeProfessor}</span>
            </div>
            <div className='w-px h-8 bg-border'></div>
            <div className='flex flex-col'>
              <span className='text-xs text-text-muted font-bold uppercase'>HORÁRIO</span>
              <span className='text-sm font-semibold text-text-main'>{horarioFormatado}</span>
            </div>
          </div>
        </div>
